...
for del in $( (cd %{buildroot}%{_libdir}/eclipse/plugins && ls | grep -v -e '^org\.eclipse\.emf' ) ) ; do
...
- Only build core modules before Eclipse is bootstrapped

* Wed Jul 27 2016 Mat Booth <mat.booth@redhat.com> - 2.12.0-1.1
